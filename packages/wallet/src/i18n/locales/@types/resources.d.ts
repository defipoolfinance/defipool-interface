  ...
  "en-US": {
    "account": {
      ...
      "wallet": {
        ...
        "remove": {
          "check": "I backed up my recovery phrase and understand that DeFi Pool Labs can’t help me recover my wallets if I failed to do so.",
      ...
      "tokens": {
        ...
        "sort": {
          ...
          "option": {
            ...
            "totalValueLocked": "DeFi Pool TVL",
            "volume": "DeFi Pool volume (24H)"
          }
        },
        "top": {
          "title": "Top tokens"
    ...
    "extension": {
      ...
      "lock": {
        ...
        "password": {
          ...
          "reset": {
            "description": {
              "default": "To reset your password, enter your wallet’s recovery phrase. DeFi Pool cannot help recover your password.",
    ...
    "forceUpgrade": {
      ...
      "description": "The version of DeFi Pool Wallet you’re using is out of date and is missing critical upgrades. If you don’t update the app or you don’t have your recovery phrase written down, you won’t be able to access your assets.",
      "label": {
    ...
    "home": {
      ...
      "extension": {
        ...
        "pin": "Pin DeFi Pool Wallet to your browser toolbar by clicking on the <puzzleIcon />"
      },
      "feed": {
        "empty": {
    ...
    "notifications": {
      "scantastic": {
        "subtitle": "Continue on DeFi Pool Extension",
        "title": "Success"
      }
    },
    "onboarding": {
      "backup": {
        ...
        "view": {
          "disclaimer": "I understand that if I lose my recovery phrase, DeFi Pool Labs cannot help me restore it",
          "subtitle": {
      ...
      "complete": {
        ...
        "footer": "Learn how to use the DeFi Pool Wallet",
      ...
      "extension": {
        "connectMobile": {
          ...
          "title": "Have the DeFi Pool mobile app?"
        },
        "password": {
      ...
      "notification": {
        "permission": {
          "message": "To receive notifications, turn on notifications for DeFi Pool Wallet in your device’s settings.",
      ...
      "scan": {
        "button": "Scan with DeFi Pool app",
        ...
        "otp": {
          ...
          "subtitle": "Check your DeFi Pool mobile app for the 6-character code",
          "title": "Enter one-time code"
        },
        "subtitle": "Scan the QR code with the DeFi Pool app to import your wallet",
    ...
    "qrScanner": {
      ...
      "wallet": {
        "networks": {
          "description": "DeFi Pool Wallet supports tokens on Ethereum, Polygon, Arbitrum, Optimism, Base, and BNB Chain. Right now, we only support NFTs on Ethereum.",
    ...
    "scantastic": {
      "code": {
        "expired": "Expired",
        "subtitle": "Enter this code in the DeFi Pool Extension. Your recovery phrase will be safely encrypted and transferred.",
        "timeRemaining": {
          "shorthand": {
      ...
      "confirmation": {
        ...
        "subtitle": "Only continue if you are syncing with the DeFi Pool Extension on a trusted device.",
      ...
      "error": {
        ...
        "timeout": {
          "message": "Scan the QR code on the DeFi Pool Extension again to continue syncing your wallet.",
    ...
    "send": {
      ...
      "warning": {
        "blocked": {
          ...
          "modal": {
            "message": "This address is blocked on DeFi Pool Wallet because it is associated with one or more blocked activities. If you believe this is an error, please email compliance@uniswap.org.",
    ...
    "setting": {
      "recoveryPhrase": {
        ...
        "remove": {
          ...
          "confirm": {
            "subtitle": "I understand that DeFi Pool Labs can’t help me recover my wallet if I failed to do so",
      ...
      "setting": {
        ...
        "backup": {
          ...
          "delete": {
            ...
            "warning": "If you delete your {{cloudProviderName}} backup, you’ll only be able to recover your wallet with a manual backup of your recovery phrase. DeFi Pool Labs can’t recover your assets if you lose your recovery phrase."
          },
          "error": {
            "message": {
          ...
          "password": {
            "disclaimer": "DeFi Pool Labs does not store your password and can’t recover it, so it’s crucial you remember it.",
            "error": {
        ...
        "biometrics": {
          ...
          "off": {
            "message": {
              "android": "Biometrics is currently turned off for DeFi Pool Wallet—you can turn it on in your system settings.",
              "ios": "{{biometricsMethod}} is currently turned off for DeFi Pool Wallet—you can turn it on in your system settings."
            },
            "title": {
          ...
          "warning": {
            "message": {
              "android": "If you don’t turn on {{biometricsMethod}}, anyone who gains access to your device can open DeFi Pool Wallet and make transactions.",
              "ios": "If you don’t turn on biometrics, anyone who gains access to your device can open DeFi Pool Wallet and make transactions."
            },
            "title": "Are you sure?"
          }
        },
        ...
        "language": {
          ...
          "description": "DeFi Pool defaults to your device‘s language settings. To change your preferred language, go to “Uniswap” in your device settings and tap on “Language”",
          "title": "Language"
        },
        "password": {
        ...
        "privacy": {
          "analytics": {
            "description": "We use anonymous usage data to enhance your experience across DeFi Pool Labs products. When disabled, we only track errors and essential usage.",
    ...
    "swap": {
      ...
      "warning": {
        ...
        "feeOnTransfer": {
          "message": "Some tokens take a fee when they are bought or sold, which is set by the token issuer. DeFi Pool does not receive any share of these fees.",
        ...
        "networkFee": {
          "message": "This is the cost to process your transaction on the blockchain. DeFi Pool does not receive any share of these fees."
        },
        "offline": {
    ...
    "token": {
      ...
      "safetyLevel": {
        "blocked": {
          ...
          "message": "You can’t trade this token using the DeFi Pool Wallet."
        },
        "medium": {
          "header": "Caution",
        ...
        "strong": {
          "header": "Warning",
          "message": "This token isn’t traded on leading U.S. centralized exchanges or frequently swapped on DeFi Pool. Always conduct your own research before trading."
        }
      },
      "selector": {
        "search": {
    ...
    "walletConnect": {
      ...
      "error": {
        "connection": {
          "message": "DeFi Pool Wallet currently supports {{chainNames}}. Please only use \"{{dappName}}\" on these chains",
