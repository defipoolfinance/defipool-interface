...
// Temporary mock all variables from "react-native-dotenv" jus to
// tet app started
const APPSFLYER_API_KEY = 'APPSFLYER_API_KEY'
const APPSFLYER_APP_ID = 'APPSFLYER_APP_ID'
const FIAT_ON_RAMP_API_URL = 'FIAT_ON_RAMP_API_URL'
const FIREBASE_APP_CHECK_DEBUG_TOKEN = 'FIREBASE_APP_CHECK_DEBUG_TOKEN'
const INFURA_PROJECT_ID = 'INFURA_PROJECT_ID'
const MOONPAY_API_KEY = 'MOONPAY_API_KEY'
const MOONPAY_API_URL = 'MOONPAY_API_URL'
const MOONPAY_WIDGET_API_URL = 'MOONPAY_WIDGET_API_URL'
const ONESIGNAL_APP_ID = 'ONESIGNAL_APP_ID'
const QUICKNODE_BNB_RPC_URL = 'QUICKNODE_BNB_RPC_URL'
const SENTRY_DSN = 'SENTRY_DSN'
const SIMPLEHASH_API_KEY = 'SIMPLEHASH_API_KEY'
const SIMPLEHASH_API_URL = 'SIMPLEHASH_API_URL'
const STATSIG_PROXY_URL = 'STATSIG_PROXY_URL'
const TRADING_API_KEY = 'TRADING_API_KEY'
const TRADING_API_URL = 'TRADING_API_URL'
const UNISWAP_API_BASE_URL = 'UNISWAP_API_BASE_URL'
const UNISWAP_API_KEY = 'UNISWAP_API_KEY'
const UNISWAP_APP_URL = 'UNISWAP_APP_URL'
const UNITAGS_API_URL = 'UNITAGS_API_URL'
...
const _config: Config = {
  ...
  clientWebUrl: process.env.REACT_APP_CLIENT_WEB_URL || 'https://dex.itproject.dev', // TODO: change default to prod
}
