...
export function useUnitagQuery(
  ...
  return useRestQuery<UnitagUsernameResponse, Record<string, unknown>>(
    ...
    {
      skip: true, // !username, // skip if username is not provided
 ...
 * @deprecated uniswap api
 */
export function useUnitagByAddressQuery( // TODO: REMOVE IT
  address?: Address
  ...
  return useRestQuery<UnitagAddressResponse, Record<string, unknown>>(
    ...
    {
      skip: true, // !address, // skip if address is not provided
      ttlMs: ONE_MINUTE_MS * 2,
    },
    'GET',
    unitagsApolloClient
