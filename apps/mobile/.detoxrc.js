...
module.exports = {
  ...
  apps: {
    'ios.debug': {
      ...
      build: "RN_SRC_EXT=e2e.js,e2e.ts xcodebuild -workspace ios/Uniswap.xcworkspace -scheme DeFi Pool -configuration Debug -sdk iphonesimulator -derivedDataPath ios/build -UseModernBuildSystem=YES -arch x86_64"
    },
    'ios.release': {
      type: 'ios.app',
      binaryPath: "ios/build/Build/Products/Dev-iphonesimulator/Uniswap.app",
      build: "RN_SRC_EXT=e2e.js,e2e.ts xcodebuild -workspace ios/Uniswap.xcworkspace -scheme DeFi Pool -configuration Dev -sdk iphonesimulator -derivedDataPath ios/build -UseModernBuildSystem=YES -arch x86_64"
    },
    'android.debug': {
      type: 'android.apk',
