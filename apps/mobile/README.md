...
[DeFi Pool Wallet](https://wallet.uniswap.org/) is the simplest, safest, and most powerful self-custodial crypto wallet. It is developed by the DeFi Pool Labs team, inventors of the DeFi Pool Protocol.

If you have suggestions on how we can improve the app, or would like to report a bug or a problem, check out the [DeFi Pool Help Center](https://support.uniswap.org/).
...
Hopefully you now (after a few minutes) see the DeFi Pool Wallet running in the iOS Simulator!
