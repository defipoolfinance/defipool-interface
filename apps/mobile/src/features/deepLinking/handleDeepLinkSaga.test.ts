...
describe(handleDeepLink, () => {
  ...
  it('Handles WalletConnect connection using DeFi Pool URL scheme with WalletConnect URI as query param', () => {
    return expectSaga(handleDeepLink, {
  ...
  it('Handles WalletConnect connection using DeFi Pool URL scheme with WalletConnect URI', () => {
    return expectSaga(handleDeepLink, {
