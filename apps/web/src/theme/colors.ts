...
export const darkTheme = {
  ...
  surface7: colors.surface7_dark,

  accent1: colors.accent1_dark,
  accent2: colors.accent2_dark,
  accent3: colors.accent3_dark,
  accent4: colors.accent4_dark,
  accent5: colors.accent5_dark,
  accent6: colors.accent6_dark,
  accent7: colors.accent7_dark,
...
export const lightTheme: ThemeColors = {
  ...
  neutral4: colors.neutral4_light,
  neutralContrast: colors.white,
  ...
  surface7: colors.surface7_light,

  accent1: colors.accent1_light,
  accent2: colors.accent2_light,
  accent3: colors.accent3_light,
  accent4: colors.accent4_light,
  accent5: colors.accent5_light,
  accent6: colors.accent6_light,
  accent7: colors.accent7_light,
