...
export function ThemeColorMetaUpdater() {
  ...
  useEffect(() => {
    ...
    if (isDark) {
      ...
      meta.setAttribute('content', '#14151D')
    } else {
...
export function useIsDarkMode(): boolean {
  ...
  const isDark = (mode === ThemeMode.AUTO ? systemTheme : mode) === ThemeMode.DARK
  const enableTheming = false
  return enableTheming ? isDark : true
}
