...
function getDeprecatedTheme(darkMode: boolean) {
  return {
    ...
    deprecated_backgroundScrolledOnce: opacify(80, '#373737'),
    ...
    deprecated_shallowShadow: darkMode ? '0 0 10px 0 rgba(34, 34, 34, 0.04);' : '0 0 10px 0 rgba(34, 34, 34, 0.04);',

    deprecated_networkDefaultShadow: darkMode
      ? `0 40px 120px ${opacify(16, colors.accent1_dark)}`
      : `0 40px 120px ${opacify(12, colors.accent1_light)}`,

    deprecated_stateOverlayHover: opacify(8, colors.surface2_dark),
