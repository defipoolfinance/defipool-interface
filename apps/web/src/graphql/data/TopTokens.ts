...
import { isPricePoint, PricePoint, supportedChainIdFromGQLChain, toHistoryDuration, unwrapToken } from './util'
...
export function useTopTokens(chain: Chain): UseTopTokensReturnValue {
  ...
  // )
  const { data: sparklineQuery } = { data: undefined as TopTokensSparklineQuery | undefined }
  ...
  const {
    ...
    loading: loadingTokens,
    error,
  } = { data: undefined as TopTokens100Query | undefined, loading: false, error: undefined }
