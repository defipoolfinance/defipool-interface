...
export const darkTheme: Theme = {
  colors: {
    ...
    dropShadow: `0 4px 16px rgba(76, 130, 251, 0.4)`,
  },
  shadows: {
    menu: '0 10px 30px rgba(0, 0, 0, 0.1)',
    elevation: '0 4px 16px rgba(70, 115, 250, 0.4)',
    tooltip: '0 4px 16px rgba(255, 255, 255, 0.2)',
