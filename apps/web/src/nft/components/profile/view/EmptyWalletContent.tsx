...
const ActionButton = styled.button`
  ...
  padding: 14.521px 36.303px;
  color: ${({ theme }) => theme.white};
  width: min-content;
  border: none;
  outline: none;
  border-radius: 90.758px;
  white-space: nowrap;
  cursor: pointer;
  margin-top: 20px;
  font-weight: 535;
...
const EMPTY_WALLET_CONTENT: { [key in EmptyWalletContentType]: EmptyWalletContent } = {
  nft: {
    ...
    urlPath: '/nfts',
    icon: showDeprecated ? <EmptyNftsIcon /> : null,
  },
  token: {
  ...
  pool: {
    ...
    urlPath: '/pool',
    icon: showDeprecated ? <EmptyPoolsIcon /> : null,
  },
}
