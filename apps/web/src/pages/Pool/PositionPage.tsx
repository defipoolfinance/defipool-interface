...
function PositionPageContent() {
  ...
  return loading || poolState === PoolState.LOADING || !feeAmount ? (
    ...
    <Trace page={InterfacePageName.POOL_PAGE} shouldLogImpression>
      <>
        <Helmet>
          <title>{t`Manage ${currencyQuote?.symbol}/${currencyBase?.symbol} pool liquidity on DeFi Pool`}</title>
        </Helmet>
        <PageWrapper>
            ...
            <AutoColumn gap="sm">
              ...
              <ResponsiveRow>
                <PositionLabelRow>
                  ...
                  {showAsLink ? (
                    <StyledPoolLink
                      to={poolAddress ? getPoolDetailsURL(poolAddress, chainIdToBackendName(chainId)) : ''}
                    >
                      <PairHeader>
