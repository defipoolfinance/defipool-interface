...
import { isAvailableForOurChains, isSupportedChain } from 'constants/chains'
import { useFilterPossiblyMaliciousPositions } from 'hooks/useFilterPossiblyMaliciousPositions'
import { useNetworkSupportsV2 } from 'hooks/useNetworkSupportsV2'
import { useV3Positions } from 'hooks/useV3Positions'
import { PoolVersionMenu } from 'pages/Pool/shared'
import { useMemo } from 'react'
import { AlertTriangle, BookOpen, ChevronDown, Inbox } from 'react-feather'
...
const MainContentWrapper = styled.main`
  ...
  border: 1px solid ${({ theme }) => theme.accent7};
  padding: 0;
  border-radius: 16px;
  display: flex;
  flex-direction: column;
          ...
          <AutoColumn gap="lg" style={{ width: '100%' }}>
            <TitleRow padding="0">
              <Row gap="md" width="min-content">
                ...
                {showVersions ? <PoolVersionMenu protocolVersion={ProtocolVersion.V3} /> : null}
              </Row>
              <ButtonRow>
                {showMore && networkSupportsV2 && (
                  <PoolMenu
                ...
                {!isAvailableForOurChains(chainId) ? null : (
            ...
            <MainContentWrapper>
              {positionsLoading ? (
                ...
                isAvailableForOurChains(chainId) ? (
                <PositionList
                ...
                <ErrorContainer>
                  <ThemedText.BodyPrimary color={theme.neutral3} textAlign="center">
                    ...
                    <div>
                      {!isAvailableForOurChains(chainId) ? (
                        <Trans>Positions are not available on this chain</Trans>
                      ) : (
                  ...
                  {showConnectAWallet && isAvailableForOurChains(chainId) && (
                    <TraceEvent
