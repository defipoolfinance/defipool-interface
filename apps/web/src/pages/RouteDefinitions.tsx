...
const SwapTitle = t`Buy, sell & trade Ethereum and other top tokens on DeFi Pool`

export const routes: RouteDefinition[] = [
  createRouteDefinition({
    path: '/',
    getTitle: () => t`DeFi Pool |Trade crypto & NFTs safely on the top DeFi exchange`,
    getElement: (args) => {
  ...
  createRouteDefinition({
    ...
    getTitle: () => t`Buy & sell on DeFi Pool`,
  ...
  createRouteDefinition({
    ...
    getTitle: () => t`Explore pools on DeFi Pool`,
    getElement: () => (
  ...
  createRouteDefinition({
    path: '/vote/*',
    getTitle: () => t`Vote on governance proposals on DeFi Pool`,
    getElement: () => (
  ...
  createRouteDefinition({
    ...
    getTitle: () => t`Create a new governance proposal on DeFi Pool`,
    getElement: () => <Navigate to="/vote/create-proposal" replace />,
  }),
  createRouteDefinition({
    path: '/send',
    getElement: () => <Swap />,
    getTitle: () => t`Send tokens on DeFi Pool`,
  }),
  createRouteDefinition({
    path: '/limits',
  ...
  createRouteDefinition({
    ...
    getTitle: () => t`Explore top liquidity pools (v2) on DeFi Pool`,
  }),
  createRouteDefinition({
    path: '/pool/v2',
    getElement: () => <PoolV2 />,
    getTitle: () => t`Provide liquidity to pools (v2) on DeFi Pool`,
  }),
  createRouteDefinition({
    path: '/pool',
    getElement: () => <Pool />,
    getTitle: () => t`Manage & provide pool liquidity on DeFi Pool`,
  }),
  createRouteDefinition({
    path: '/pool/:tokenId',
    getElement: () => <PositionPage />,
    getTitle: () => t`Manage pool liquidity on DeFi Pool`,
  }),
  createRouteDefinition({
    path: '/pools/v2/find',
    getElement: () => <PoolFinder />,
  ...
  //   path: '/pools/v2',
  //   getElement: () => <PoolV2 />,
  //   getTitle: () => t`Manage & provide v2 pool liquidity on DeFi Pool`,
  // }),
  createRouteDefinition({
    path: '/pools',
    getElement: () => <Pool />,
  ...
  createRouteDefinition({
    ...
    getTitle: () => t`Provide liquidity to pools on DeFi Pool`,
  }),
  createRouteDefinition({
    path: '/remove/v2/:currencyIdA/:currencyIdB',
    getElement: () => <RemoveLiquidity />,
    getTitle: () => t`Manage v2 pool liquidity on DeFi Pool`,
  }),
  createRouteDefinition({
    path: '/remove/:tokenId',
  ...
  createRouteDefinition({
    ...
    getTitle: () => t`Migrate v2 pool liquidity to DeFi Pool v3`,
  }),
  createRouteDefinition({
  ...
  createRouteDefinition({
    ...
    getTitle: () => t`Trade NFTs across OpenSea & other top marketplaces on DeFi Pool`,
  }),
  createRouteDefinition({
    ...
    enabled: (args) => !args.shouldDisableNFTRoutes,
    getTitle: () => t`Explore NFTs on DeFi Pool`,
  }),
  createRouteDefinition({
    path: '/nfts/profile',
    getElement: () => (
