            ...
            <VoteCard>
              ...
              <CardSection>
                <AutoColumn gap="md">
                  <RowBetween>
                    <Header>
                      <Trans>DeFi Pool governance</Trans>
                    </Header>
                  </RowBetween>
                  <RowBetween>
                    <ThemedText.DeprecatedWhite fontSize={14}>
                      <Trans>
                        UNI tokens represent voting shares in DeFi Pool governance. You can vote on each proposal
                  ...
                  >
                    <ThemedText.DeprecatedWhite fontSize={14}>
                      <Trans>Read more about DeFi Pool governance</Trans>
                    </ThemedText.DeprecatedWhite>
                  </ExternalLink>
                </AutoColumn>
              </CardSection>
