    ...
    switch (warning.level) {
      ...
      case WARNING_LEVEL.UNKNOWN:
        heading = (
          <Plural
            ...
            } isn't traded on leading U.S. centralized exchanges or frequently swapped on DeFi Pool.`}
            other="These tokens aren't traded on leading U.S. centralized exchanges or frequently swapped on DeFi Pool."
          />
        )
        description = <Trans>Always conduct your own research before trading.</Trans>
        break
      case WARNING_LEVEL.BLOCKED:
        description = (
          <Plural
            value={plural ? 2 : 1}
            _1={`You can't trade ${tokenSymbol ?? 'this token'} using the DeFi Pool App.`}
            other="You can't trade these tokens using the DeFi Pool App."
          />
        )
        break
    }
