...
const OUR_LIQUIDITY_SUPPORTED_CHAIN_IDS: SupportedInterfaceChain[] = [ChainId.BNB, ChainId.BNB_TESTNET, ChainId.MAINNET]

export function isAvailableForOurChains(
  chainId: number | null | undefined | ChainId
): chainId is SupportedInterfaceChain {
  return !!chainId && OUR_LIQUIDITY_SUPPORTED_CHAIN_IDS.indexOf(chainId) !== -1
}
