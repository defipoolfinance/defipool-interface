...
export const USDT_BSC_TESTNET = new Token(
  ChainId.BNB_TESTNET,
  '0x7CE086A43a4e19edd5f3A2171a1fd510102BB0Fe',
  18,
  'USDT',
  'USDT'
)
export const DAI_BSC_TESTNET = new Token(
  ChainId.BNB_TESTNET,
  '0xec15ef13257a5770BF19cb4E64B15b5AAE0E7a5b',
  18,
  'DAI',
  'DAI Stable'
)
...
export const LCC_BSC_TESTNET = new Token(
  ChainId.BNB_TESTNET,
  '0xa47ef2636163Fc4b19241D1796165F066c630611',
  18,
  'LCC',
  'Local Coins'
)
...
export const WBNB_BSC_TESTNET = new Token(
  ChainId.BNB_TESTNET,
  '0x0e1b74b76704330d040f483852595DCCE40E7089',
  18,
  'WBNB',
  'WBNB'
)
...
function isBscTestnet(chainId: number): chainId is ChainId.BNB_TESTNET {
  return chainId === ChainId.BNB_TESTNET
}
...
class BscTestnetNativeCurrency extends NativeCurrency {
  ...
  get wrapped(): Token {
    if (!isBscTestnet(this.chainId)) throw new Error('Not tbnb')
    const wrapped = WRAPPED_NATIVE_CURRENCY[this.chainId]
    invariant(wrapped instanceof Token)
    return wrapped
  }
  ...
  public constructor(chainId: number) {
    if (!isBscTestnet(chainId)) throw new Error('Not tbnb')
...
export function nativeOnChain(chainId: number): NativeCurrency | Token {
  ...
  if (isPolygon(chainId)) {
    ...
    nativeCurrency = new BscTestnetNativeCurrency(chainId)
...
const STABLECOINS: { [chainId in ChainId]: Token[] } = {
  ...
  [ChainId.BNB_TESTNET]: [USDC_BSC_TESTNET],
