...
import { apiKyberswap } from 'rest/kyberswap/api-kyberswap'
import { apiParaswap } from 'rest/paraswap/api-paraswap'
import { apiUsd } from 'rest/usd/api-usd'
...
type ExpectedAppState = CombinedState<{
  ...
  [apiKyberswap.reducerPath]: ReturnType<typeof apiKyberswap.reducer>
  [apiParaswap.reducerPath]: ReturnType<typeof apiParaswap.reducer>
  [apiUsd.reducerPath]: ReturnType<typeof apiUsd.reducer>
