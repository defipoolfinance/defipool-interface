...
export function isSubmittableTrade(trade?: InterfaceTrade | OperableTrade): trade is SubmittableTrade {
...
export function isKyberswapTrade(trade?: InterfaceTrade): trade is KyberswapTrade {
  return trade?.fillType === TradeFillType.Kyberswap
}

export function isParaswapTrade(trade?: InterfaceTrade): trade is ParaswapTrade {
  return trade?.fillType === TradeFillType.Paraswap
}
