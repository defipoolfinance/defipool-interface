...
export const PositionPreview = ({
  ...
  // sometimes it changes to wrong reference to some object
  const sorted = baseCurrency.symbol === currency0.symbol && baseCurrency.wrapped.address === currency0.wrapped.address
