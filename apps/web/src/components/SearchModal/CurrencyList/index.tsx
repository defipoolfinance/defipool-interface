...
const FixedSizeListWrapper = styled.div`
  &::-webkit-scrollbar {
      ...
      >
        ...
        >
          ...
          <AutoColumn style={{ opacity: isBlockedToken ? blockedTokenOpacity : '1' }}>
            ...
            <ThemedText.LabelMicro ml="0">{currency.symbol}</ThemedText.LabelMicro>
          </AutoColumn>
          <Column>
...
export default function CurrencyList({
  ...
  return (
    <FixedSizeListWrapper data-testid="currency-list-wrapper">
      {isLoading ? (
        <FixedSizeList
