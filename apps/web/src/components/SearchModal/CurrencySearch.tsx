...
import { CloseIcon, CloseIconWrapper, ThemedText } from 'theme/components'
...
import { PaddedColumn, SearchInput } from './styled'
...
const SearchIconWrapper = styled.div<{ onClick?: any }>`
  border-radius: 50%;
  ...
  return (
    <ContentWrapper>
      ...
      >
        ...
        <Separator />
        {/* <pre>{JSON.stringify({ allCurrencyRows, otherSelectedCurrency, selectedCurrency }, null, 2)}</pre> */}
        {searchCurrency ? (
          <Column style={{ padding: '120px 0', height: '100%' }}>
            <CurrencyRow
