...
const NavItem = styled(ThemedText.SubHeader)<{ active?: boolean }>`
  ...
  border-radius: 900px;
  background: ${({ theme, active }) => (active ? theme.accent4 : '#20242F')};
  padding: 8px 32px;
  ...
  &:hover {
    ${({ theme, active }) => !active && `color: ${theme.neutral1};background:${theme.accent4}`};
  }
`
