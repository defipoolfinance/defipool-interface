  ...
  switch (errorType) {
    case PendingModalError.TOKEN_APPROVAL_ERROR:
      return {
        ...
        message: (
          <Trans>
            This provides the DeFi Pool protocol access to your token for trading. For security, it expires after 30
            days.
          </Trans>
        ),
    ...
    case PendingModalError.WRAP_ERROR:
      return {
        ...
        message: (
          <Trans>
            Swaps on the DeFi Pool Protocolcan start and end with ETH. However, during the swap ETH is wrapped into
            WETH.
          </Trans>
        ),
    ...
    <Container gap="md">
      <Section gap="md">
        ...
        <ThemedText.BodyPrimary>
          {message}{' '}
          {supportArticleURL && showLearnMore && (
